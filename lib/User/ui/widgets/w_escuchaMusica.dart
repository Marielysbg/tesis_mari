...
class w_escuchaMusica extends StatelessWidget{

  User user = new User();
  w_escuchaMusica(this.user);
  Stream<DocumentSnapshot> courseDocStream = Firestore.instance.collection('REPOSITORIOS').document('escuchaMusica').snapshots();
