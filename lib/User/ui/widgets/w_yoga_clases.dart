...
class w_yoga_clases extends StatelessWidget{

  User user = new User();
  w_yoga_clases(this.user);
  Stream<DocumentSnapshot> courseDocStream = Firestore.instance.collection('REPOSITORIOS').document('yoga').snapshots();
