...
class screen_favorito extends StatelessWidget{

  User user = new User();
  screen_favorito(this.user);


  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    Stream<DocumentSnapshot> courseDocStream = Firestore.instance.collection('FAVORITOS').document(user.uid).snapshots();
    return Scaffold(
